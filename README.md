...
თქვენს პროექტში შრიფტის გამოსაყენებლად, უბრალოდ გადმოწერეთ <a href="https://fonts.google.com/noto/specimen/Noto+Sans+Georgian?query=noto+sans+georg">ატვირთული</a >შესაბამისი ფაილები საცავიდან და დაამატეთ ისინი თქვენი პროექტის დირექტორიაში. შემდეგ შეგიძლიათ ჩართოთ შრიფტი თქვენს CSS-ში @font-face წესის გამოყენებით.
